...
Summary(pl):	Wtyczka do adminstracji projektami Traca przez interfejs ³ebowy
...
%description -l pl
Wtyczka dla Traca s³u¿±ca do aministracji projektami poprzez ³ebowy
interfejs. Jest ci±gle rozwijana jednak udostepnia ju¿ wiêksz± czê¶æ
funkcjonalo¶ci programu trac-admin
